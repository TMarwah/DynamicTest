//
//  assignmentQuestions.c
//  parameterFunctionQuestion(s)
//
//  Created by Tanmay Marwah on 9/21/19.
...
int assignmentQuestionMaker(double arg1, char operator, double arg2) { //function that creates math questions based off of given paramters
    char question[80];
    printf("The left side argument is value 'A' \n");
    printf("What is the new value of A after...\n");
    ...
    return askAssignQuestion(question, answer, choice);
    
}

int assignmentQuestions(int questions)
{
    int score=0;
    char operators[] = {'+', '-', '/', '*', '%'};
    char operatorRand;
    ...
    for (int i = 0; i < questions; i++) {
        ...
        score += assignmentQuestionMaker(arg1Rand, operatorRand, arg2Rand);
